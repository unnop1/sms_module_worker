...
public class KafkaConsumerService {
    ...
    @KafkaListener(
        ...
        // DEV
        topics = {"BULKPREPROVISIONING","CHANGEMSISDN","CHANGEOWNER","CHANGEPACKAGE","CONTRACTMANAGEMENT","CREDITLIMIT","EXTENDEXPIRATIONDATE","NEW","NOTIFICATIONPACKAGESTATUSCHANGE","PACKAGEEXPIRE","RECONNECT","SUSPEND","SWAPPOSTPAIDTOPREPAID","SWAPPREPAIDTOPOSTPAID","TERMINATE","TOPUPRECHARGE","VARIETYSERVICE"},

...
public class KafkaConsumerService {
    ...
    @KafkaListener(
        autoStartup="true",
        // PRODUCTION
        topics = {"NEW","SUSPEND","RECONNECT","CHANGEPACKAGE","TOPUPRECHARGE","PACKAGEEXPIRE", "NOTIFICATIONAUTORECONNECT", "PORTIN"}, 

        // DEV
        // topics = {"NEW","SUSPEND","RECONNECT","CHANGEPACKAGE","CHANGESIM","TOPUPRECHARGE","PACKAGEEXPIRE","BULKPREPROVISIONING","CHANGEMSISDN","CHANGEOWNER","CONTRACTMANAGEMENT","CREDITLIMIT","EXTENDEXPIRATIONDATE","NOTIFICATIONPACKAGESTATUSCHANGE","SWAPPOSTPAIDTOPREPAID","SWAPPREPAIDTOPOSTPAID","TERMINATE","VARIETYSERVICE", "NOTIFICATIONAUTORECONNECT", "PORTIN"},
